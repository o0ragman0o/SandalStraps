...
//
    ...
    function withdrawAll()
        ...
        returns (bool)
    {
        Withdrawal(msg.sender, owner, address(this).balance);
...
//
    ...
    {
        creator = _creator;
        metaRegistrar = Registrar(RegistrarFactory(BOOTSTRAP).createNew("metaregistrar", 0x0));
...
/* Public non-constant Functions */ 
        ...
        returns (bool)
    {
        ...
        Withdrawal(msg.sender, wallet, address(this).balance);
...
//
    ...
    /// @dev On 0x0 value for _owner or _creator, ownership precedence is:
    /// `_owner` else `_creator` else msg.sender
    function SandalStrapsFactory(address _creator, bytes32 _regName, address _owner)
        public
        Factory(_creator, regName, _owner)
    {
        _regName; // Not passed to super. Quiet compiler warning
